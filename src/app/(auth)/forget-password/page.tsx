...
const ForgetPassword = () => {
    const {register,formState:{errors,isSubmitting},reset,handleSubmit} = useForm<TForgetPasswordSchema>({resolver:zodResolver(forgetPasswordSchema)})
            ...
            <div className="container2 mx-auto drop-shadow">
                <div className="flex justify-center px-6 my-12">
                    ...
                    <div className="w-full xl:w-3/4 lg:w-11/12 flex">
                        ...
                        <div
                            className="w-full h-auto bg-[url('https://source.unsplash.com/oWTW-jNGl9I/600x800')] bg-gray-400 hidden lg:block lg:w-1/2 bg-cover rounded-l-lg"
