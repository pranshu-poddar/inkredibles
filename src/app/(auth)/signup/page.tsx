...
const SignUp = () => {
    ...
    const { register, handleSubmit, reset, formState: { isSubmitting, errors } } = useForm<TSignupSchema>({ resolver: zodResolver(signupSchema) });
            ...
            <div className="container mx-auto">
                <div className="flex justify-center px-6 my-12">
                    ...
                    <div className="w-full xl:w-3/4 lg:w-11/12 flex">
                        ...
                        <div
                            className="w-full h-auto bg-[url('https://source.unsplash.com/Mv9hjnEUHR4/600x800')] bg-gray-400 hidden lg:block lg:w-5/12 bg-cover rounded-l-lg"
                                ...
                                <div className="mb-10 md:flex md:justify-between">
                                    ...
                                    <div className="md:ml-2">
                                        ...
                                        <input
                                            ...
                                            placeholder="phone"
                                        />
                                        {errors.phone && <p className='text-red-500 absolute'>{errors.phone.message}</p>}
                                    </div>
                                </div>
                                <div className="mb-10 md:flex md:justify-between">
                                    <div className="mb-4 md:mr-2 md:mb-0 relative">
                                        ...
                                        />
                                        <div onClick={() => setpasswordVisibility(!passwordVisibility)} className='absolute -right-6 top-10 cursor-pointer'>
                                    ...
                                    <div className="md:ml-2">
                                        ...
                                        <input
                                            ...
                                            placeholder="******************"
                                        />
                                        {errors.confirmPassword && <p className='text-red-500 absolute'>{errors.confirmPassword.message}</p>}
                                    </div>
                                </div>
