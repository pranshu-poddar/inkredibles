  ...
  return (
    <main className="mt-10">
      <div className="mb-4 md:mb-0 w-full max-w-screen-md mx-auto relative h-[24em]">
        <div className="absolute left-0 bottom-0 w-full h-full z-10 bg-gradient-to-b from-transparent to-black bg-opacity-70" ></div>
        <img alt='blog image' src={HomeAssets.SpecialBanner} />
        <div className="p-4 absolute bottom-0 left-0 z-20">
          ...
          <div className="flex mt-3">
            <img alt='user avatar' src="https://randomuser.me/api/portraits/men/97.jpg"
