                        ...
                        <div className="flex flex-col items-stretch justify-center w-full space-y-4 md:flex-row md:space-y-0 md:space-x-8">
                            <div className="flex flex-col w-full space-y-6 ">
                                ...
                                <div className="flex flex-col items-center justify-center w-full pb-4 space-y-4 border-b border-gray-200 ">
                                    <div className="flex justify-between w-full">
                                        ...
                                        <p className="text-base leading-4 text-gray-600 ">Rs.1000</p>
                                    </div>
                                ...
                                <div className="flex items-center justify-between w-full">
                                    ...
                                    <p className="text-base font-semibold leading-4 text-gray-600 ">Rs.700</p>
                                </div>
                            </div>
                            <div className="flex flex-col w-full px-2 space-y-4 md:px-8 ">
                                ...
                                <div className="flex items-start justify-between w-full">
                                    ...
                                    <p className="text-lg font-semibold leading-6 text-gray-800 ">Rs.50</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-wrap items-center justify-start gap-4 px-4 mt-6 ">
                        <button className="w-full px-4 py-2 text-blue-500 border border-blue-500 rounded-md md:w-auto hover:text-gray-100 hover:bg-blue-600  dark:hover:bg-gray-700 ">
                            Go back shopping
                        </button>
                        <button className="w-full px-4 py-2 bg-blue-500 rounded-md text-gray-50 md:w-auto  hover:bg-blue-600 dark:hover:bg-gray-700 ">
                            View career details
                        </button>
                    </div>
                </div>
