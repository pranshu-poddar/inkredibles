...
const Page = () => {
    ...
    return (
        <div className='w-3/4'>
            <div className='p-6 relative justify-between w-full bg-gray-100 flex'>
                ...
                <Link href={Pages.Account} className='border rounded bg-gray-100 hover:drop-shadow text-[10px] font-bold h-fit float-right text-inkredible-black border-inkredible-black p-1.5'>EDIT PROFILE</Link>
            </div>
